...
<link rel="stylesheet" type="text/css" href="/responsive/JJinTrip/css/idFind.css">
</head>
    ...
    <div class="join">
        <div class="tiny_inner">
            ...
            <div class="emLogin mart60 marb40">
                <div class="marb40">
                    <span>이름</span>
                    <input type="text" id="" class="w_100" title="이름을 입력해주세요." placeholder="이름을 입력해주세요.">
                </div>
                <div>
                    <span>휴대전화</span>
