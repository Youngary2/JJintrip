...
<link rel="stylesheet" type="text/css" href="/responsive/JJinTrip/css/mypage/myPoint.css">
</head>
...
<body>
    ...
    <header class="pc_header">
                <div class="inner">
                    <div class="toplogo">
                        <a href="http://jldylee.dothome.co.kr/responsive/JJinTrip/pages/mypage/myPoint.php#">
        ...
        <div class="inner">
            <div class="Box_left">
                ...
                <div class="left_02">
                    <div class="myPoint marb10">
                        ...
                        <span class="rtxt orange cursor">0원 <i class="orange fa-solid fa-angle-right"></i></span>
                    </div>
                    <div class="myCoupon">
            ...
            <div class="Box_right">
                <div class="pointNow marb20">
                    <div class="usable">
                        <p class="marb16">사용가능한 포인트</p>
                        <p class="won">0원</p>
                    </div>
                    <div class="disapear">
                        <p class="marb16">소멸예정 포인트</p>
                        <p class="won">0원</p>
                    </div>
                </div>
                <ul class="descBox">
