...
<link rel="stylesheet" type="text/css" href="/responsive/JJinTrip/css/mypage/mypage.css">
</head>
...
<body>
    ...
    <div class="mypage">
        <div class="inner">
            ...
            <div class="Box_right">
                <button class="pfreSet cursor">편집</button>

                <div class="pfimgContain marb50">
                    <div class="profile_photo">
                        <img src="/responsive/JJinTrip/img/profile_image.png" alt="프로필 이미지">
                    </div>
                    <p id="nickname" class="nick mart10 marb20">댕구댕구</p>
                </div>
                <div class="pfTxtContain">
                    <div>
                        <span class="ltit">이름</span>
                        <span class="rtxt">댕구댕구</span>
                    </div><!-- //이름 -->
                    <div>
                        <span class="ltit">이메일</span>
                        <span class="rtxt">aabbccddee@naver.com</span>
                    </div><!-- //이메일 -->
                    <div>
                        <span class="ltit">연락처</span>
                        <span class="rtxt">휴대폰 정보 없음<span id="phone_inz" class="orange marl12">인증하기</span></span>
                    </div><!-- //연락처 -->
                    <div class="snsPairing">
                        <span class="ltit">SNS 연동</span>
                        <div class="rtxt">
                            <div class="naver">
                                <div class="snsName">
                                    <img src="/responsive/JJinTrip/img/round_ico_naver2.svg" alt="아이콘">
                                    네이버 연동
                                </div>
                                <div class="toggle">
                            ...
                            <div class="kakao">
                                <div class="snsName">
                                    <img src="/responsive/JJinTrip/img/round_ico_kakao2.svg" alt="아이콘">
                                    카카오 연동
                                </div>
                                <div class="toggle">
                                    <button type="button" class="btn_toggle">
                            ...
                            <div class="facebook">
                                <div class="snsName">
                                    <img src="/responsive/JJinTrip/img/round_ico_facebook2.svg" alt="아이콘">
                                    페이스북 연동
                                </div>
                                <div class="toggle">
                                    <button type="button" class="btn_toggle">
                    ...
                    <div>
                        <span class="ltit">비밀번호</span>
                        <span class="rtxt">********</span>
                    </div><!-- //비밀번호 -->
                    <div>
                        <span class="ltit">마케팅 수신동의</span>
                        <div class="rtxt">
                            <p class="marb10">e-mail: <span>수신거부</span></p>
                            <p class="marb10">sms: <span>수신거부</span></p>
                            <p>앱 푸시: <span>수신거부</span></p>
                        </div>
                    </div><!-- //마케팅 수신동의 -->
                </div>
            </div><!-- //Box_right -->
