...
<link rel="stylesheet" type="text/css" href="/responsive/JJinTrip/css/join.css">
</head>
    ...
    <div class="join">
        <div class="tiny_inner">
            ...
            <div class="buttonArea mart50 marb60">
                <button class="button w_100" onclick="location.href='/responsive/JJinTrip/pages/join02.php'">회원가입</button>
            </div>

            <div class="iconWrap">
                <span class="el"><span class="gray">SNS 간편 회원가입</span></span>
